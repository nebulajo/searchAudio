...
class SongDescriber(Dataset):
    def __init__(self, data_dir, split, caption_type, audio_loader="ffmpeg", sr=22050, duration=10, audio_enc=".mp3"):
        ...
        self.dataset_csv = os.path.join(self.data_dir, "song_describer.csv")
        self.get_split()
        self.get_columns()
    ...
    def get_split(self):
        ...
        # df_anno = pd.DataFrame(dataset) # �̰Ŷ� csv�� ���ؼ� �� ������ ���� ����ϸ� �� �� �״�� �ϵ��ڵ� �����غ���
    ...
    def __getitem__(self, index):
        item = self.annotations.iloc[index] # pandas series
        fname = item['track_id'] # series���� column ����
        text = item['caption']
